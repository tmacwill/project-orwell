<div class="container-fluid">
    ...
    <div id="home-features" class="row-fluid">
        ...
        <div class="span6" style="margin-bottom: 20px">
            <h2>The integrity of your documents is automatically verified.</h2>
            <p class="feature-description">
                Make sure your content isn't changed without you knowing. Your content will be verified against the network of individuals hosting it, and if anyone's (including yours) copy is changed, they'll be notified.
            </p>
        </div>
